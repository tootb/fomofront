...
const LevelProgress = ({ currentRound, currentLevel, gameStartTime, isActive, currentLevelStartTime }) => {
  ...
  }, [isActive, gameStartTime, getLevels]);
  ...
  const calculateTimeToNextLevel = useCallback(() => {
    ...
    return Math.max(0, timeRemaining);
  }, [getLevels, isActive, gameStartTime, currentLevelStartTime, currentLevel, getCurrentLevelIndex]);
  ...
  }, [gameStartTime, currentRound, isActive, currentLevelStartTime, currentLevel, calculateTimeToNextLevel]);
